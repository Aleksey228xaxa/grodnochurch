...
import Title from "../component/bogosluzheniya/Youth/Title";
import Text from "../component/bogosluzheniya/Youth/Text";
import { CustomImageGallery } from "../component/bogosluzheniya/Youth/Carousel";
...
export default async function Page() {
  const client = createClient()
      const document = await client.getSingle("youth")
