...
import Title from "../component/bogosluzheniya/Music/Title";
import Text from "../component/bogosluzheniya/Music/Text";
import { CustomImageGallery } from "../component/bogosluzheniya/Music/Carousel";
...
export default async function Page() {
  const client = createClient()
      const document = await client.getSingle("music_ministry")
