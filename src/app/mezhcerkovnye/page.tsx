...
import Title from "../component/bogosluzheniya/Prayers/Title";
import Text from "../component/bogosluzheniya/Prayers/Text";
import { CustomImageGallery } from "../component/bogosluzheniya/Prayers/Carousel";
...
export default async function KontaktyPage() {
  const client = createClient()
      const document = await client.getSingle("interchurch_prayers")
