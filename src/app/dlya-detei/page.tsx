...
import Title from "../component/bogosluzheniya/Children/Title";
import Text from "../component/bogosluzheniya/Children/Text";
import { CustomImageGallery } from "../component/bogosluzheniya/Children/Carousel";
...
export default async function Page() {
  const client = createClient()
      const document = await client.getSingle('for_children')
