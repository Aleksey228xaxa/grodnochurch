...
import Title from "../component/bogosluzheniya/Main/Title";
import Text from "../component/bogosluzheniya/Main/Text";
import { CustomImageGallery } from "../component/bogosluzheniya/Main/Carousel";
...
export default async function KontaktyPage() {
  const client = createClient()
      const document = await client.getSingle("general")
