...
import Title from "../component/bogosluzheniya/Foreigners/Title";
import Text from "../component/bogosluzheniya/Foreigners/Text";
import { CustomImageGallery } from "../component/bogosluzheniya/Foreigners/Carousel";
...
export default async function Page() {
  const client = createClient()
      const document = await client.getSingle("foreign_students")
