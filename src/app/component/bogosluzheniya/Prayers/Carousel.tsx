...
import { Box, Button, Paper, Modal, IconButton } from '@mui/material'
...
export function CustomImageGallery() {
  ...
  useEffect(() => {
    const fetchImages = async () => {
      ...
      const generalDoc = await client.getSingle<Content.InterchurchPrayersDocument>('interchurch_prayers')
